...
subtitle: "Classification de données avec Scikit-learn"
author: "Parcours IA"
date: last-modified
format:
  html:
...
Ce notebook démontre une analyse complète de données et un modèle de machine learning en Python, incluant :
...
Nous utilisons le célèbre dataset Iris pour cette démonstration.
...
plt.title('Distribution des Espèces d\'Iris', fontsize=14, fontweight='bold')
plt.xlabel('Espèce')
...
```{python}
# Créer un pairplot pour visualiser les relations
sns.pairplot(
    df, 
    hue='species_name',
    diag_kind='kde',
...
print("\n💡 Observations :")
print("- Petal length et petal width sont fortement corrélées (0.96)")
print("- Ces features semblent très discriminantes pour la classification")
```
...
print(f"   - Excellente séparabilité des classes")
...
- Optimisez les hyperparamètres avec GridSearchCV
- Ajoutez de la validation croisée
- Explorez le feature engineering avancé
:::
